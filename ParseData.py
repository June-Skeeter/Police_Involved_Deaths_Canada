...
class GetData(object):
    ...
    def __init__(self):
        ...
        CBC_Data = pd.read_csv('Inputs/DataSets/Deadly_Force_2020_Updates.csv',
                                parse_dates=['DATE'],
                                # index_col=['VICTIM ID']
                              encoding="latin-1"
                                )
        Missing_Records = pd.read_csv('Inputs/DataSets/MissingRecords.csv',
                              parse_dates=['DATE'],
                              # index_col=['VICTIM ID'],
                              encoding="latin-1"
                                 )

        self.CBC_Data_Original = pd.read_csv('Inputs/DataSets/Deadly_Force_2020_Original.csv',
                                parse_dates=['DATE'],
                                # index_col=['VICTIM ID']
                                )
        ...
        CA_Census['Asian'] = CA_Census['Chinese']+CA_Census['Filipino']+CA_Census['Japanese']+CA_Census['Korean']+CA_Census['Southeast Asian']
